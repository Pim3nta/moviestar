<?php
    ...
    //Verificação se o usuario está logado[se encontrou o token]
...
?>
    ...
    <div class="offset-md-4 col-md-4 new-movie-container">
        ...
        <div class="form-group">
            <!--Select de categoria que vai ser salva com o filme no banco-->
            ...
            <input type="text" class="form-control" id="trailer" name="trailer" placeholder="Insira o link do trainer">
        </div>
            <div class="form-group">
